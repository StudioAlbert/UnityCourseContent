...
public class Character : MonoBehaviour
{
    ...
    [SaveDuringPlay][SerializeField] private float _xSpeed = 10;
    [SaveDuringPlay][SerializeField] private float _xForce = 20;
    [SaveDuringPlay][SerializeField] private float _jumpForce = 10;
    ...
    [SaveDuringPlay][SerializeField] private float _hitForce;
    [SaveDuringPlay][SerializeField] private float _hitTime = 2.0f;
    ...
    //     if (!_sr)
    //     {
    //         Debug.LogError("Pas de sprite renderer");
    //     }
    // }
    ...
    private void Update()
    {
        ...
        _animator.SetBool("isJumping", Mathf.Abs(_rb.linearVelocityY) >= 0.01f);
